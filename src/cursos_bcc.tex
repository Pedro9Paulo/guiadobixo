...
um monte de optativas, para completar uma trilha, vocês tambpem tem escolhas,ou seja, 
até se escolherem seguir uma trilha vocês podem escolher as matérias que lhe agradam mais,
é claro, se elas forem oferecidas e não tiverem conflitos entre si ou até com obrigatórias, 
mas você aind está confuso? ou quer saber o que compõe cada trilha exatamente? não se preocupe, 
os links citados no começo dessa seção e as matérias MAC0101(palestrinhas 1) e MAC0102 (palestrina 2)
foram feitas justamente para \sout{aumentar sua nota} que você descubra como o BCC é um
